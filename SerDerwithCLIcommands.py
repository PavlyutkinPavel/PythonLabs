...
if __name__ == '__main__':
    ...
    format_from = SerializersFactory.create_serializer(SerializerType.XML if format_from == "xml"\
                                                            else SerializerType.JSON)
    format_to = SerializersFactory.create_serializer(SerializerType.XML if format_to == "xml"\
                                                            else SerializerType.JSON)
